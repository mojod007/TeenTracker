...
public class GlobalExceptionHandler {
    ...
    private boolean shouldReturnJson(WebRequest request) {
    ...
    public Object handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
        ...
        return createErrorView(HttpStatus.FORBIDDEN, "Forbidden",
                "Accès refusé. Vous n'avez pas les permissions nécessaires.", request);
    }
